  ...
  return (
    <div className='login'>
      ...
      <form className="login-form" onSubmit={onSubmitHandler}>
        <h2>{currState}</h2>
        {currState == "Sign up" ? <input onChange={(e) => setUserName(e.target.value)} value={userName} type="text" placeholder='Username' className='form-input' required={true} /> : null}
        ...
        <div className='login-terms'>
          <input type="checkbox" />
          <p>Agree to Terms and Conditions and Privacy Policy</p>
        </div>
